...
function CustomNavbar() { 
  return (
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        <Navbar.Brand href="#">Hamleys</Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
            <NavDropdown title="Shop Toys" id="navbarScrollingDropdown">
            ...
            <NavDropdown title="New Year's Eve" id="navbarScrollingDropdown">
              <NavDropdown.Item href="#action3">Action</NavDropdown.Item>
              <NavDropdown.Item href="#action4">
                Another action
              </NavDropdown.Item>
